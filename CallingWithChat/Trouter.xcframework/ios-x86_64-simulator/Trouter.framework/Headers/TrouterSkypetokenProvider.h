 ...
 * 
 * @return New Skypetoken to use, or nil if it is not possible to obtain the Skypetoken.
 * In case nil is returned, the operation that needs the Skypetoken will not continue.
 */
-(nullable NSString*)getSkypetoken:(BOOL)forceRefresh;
@end
